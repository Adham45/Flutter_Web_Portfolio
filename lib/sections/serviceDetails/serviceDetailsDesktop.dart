        ...
        children: [
          ...
          Align(
            ...
            child: CustomFilledBtn(
              height: 40.0,
              onPressed: () => launchURL("https://wa.me/?text=Hi Adham!"),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage(kProjectsIcons[_currentIndex]),
                          fit: BoxFit.cover)),
                  child: SizedBox(
                    height: screenSize.height * 0.55,
                    width: screenSize.width,
          ...
          Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: kProjectsIcons.map((project) {
                int index = kProjectsIcons.indexOf(project);
